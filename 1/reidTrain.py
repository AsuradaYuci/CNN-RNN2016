...
class ReidTrain:
    def __init__(self):
        ...
        parser.add_argument('-dataset', default=2, type=int, help='0- ilids debug, 1 -  ilids, 2 - prid, 3 - mars')
        ...
        parser.add_argument('-disableOpticalFlow', default=1, type=int, help='use optical flow features or not')
    ...
    def train(self):
        homeDir = os.getcwd()  # os.getcwd() 方法用于返回当前工作目录 '/home/ying/Desktop/Spatial-Temporal-Pooling-Networks-ReID-master'
        file_suffix = 'png'  # 文件后缀 png
        if self.args.dataset == 0:
            ...
            seq_root_rgb = '/home/ying/Desktop/Spatial-Temporal-Pooling-Networks-ReID-master/data/prid_2011/multi_shot/'
            seq_root_of = '/home/ying/Desktop/Spatial-Temporal-Pooling-Networks-ReID-master/data/prid2011flow'
        ...
        # build the model
        n_person_train = len(train_idx)  # 192
